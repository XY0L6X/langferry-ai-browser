    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Column(
          ...
          children: [
            Text('项目名称: 文渡 LangFerry'),
            SizedBox(height: AppDimens.spacing8),
            Text('开源协议: MIT License'),
            SizedBox(height: AppDimens.spacing8),
            Text('项目地址:'),
            Text('github.com/XY0L6X/langferry-ai-browser',
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _numberedItem(theme, '4', '点击"创建 API Key"，随便起个名字（如 文渡），点确定'),
            ...
            _numberedItem(theme, '1', '打开文渡，点击底部"设置"'),
